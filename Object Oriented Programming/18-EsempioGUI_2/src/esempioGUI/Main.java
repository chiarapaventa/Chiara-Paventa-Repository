...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        /*il metodo ActionListener, definita per ogni evento, definisce l'evento che riceve qualcosa di tipo event che può essere usato per gestire qualcosa
        ...
        */
        ...
        Quando creiamo un'interfaccia utente si crea un altro thread, poichè stiamo ragionando in modo di aspettare ciò che inserisce l'utente
