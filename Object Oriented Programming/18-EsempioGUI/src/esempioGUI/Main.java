...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        /*Un oggetto di tipo frame è diviso in più aree
        ...
        */
        ...
        /*Proviamo a fare in modo che quando viene premuto la x la prima volta non si chiude la finestra, 
        ma chiede di salvare i dati, la seconda chiude e basta, mettiamo una var che indica se è stata o meno già richiamata*/
        ...
        /*Il metodo ActionListener, definita per ogni evento, definisce l'evento 
        che riceve qualcosa di tipo event che può essere usato per gestire qualcosa
        ...
        Quando creiamo un'interfaccia utente si crea un altro thread, 
        poichè stiamo ragionando in modo di aspettare ciò che inserisce l'utente
        ...
        SwingUtilities.invokeLater(
                new Runnable(){
                    public void run (){//definiamo una classe anonima interna, solo le variabili dichiarate final possono essere viste dalle classi anonime, ma dopo Java 8 vengono viste anche le varibili final di fatto
                        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); //quanto chiudo la finestra esegue exit on close, in generale non bisogna usarla quasi mai
                    }
                });
